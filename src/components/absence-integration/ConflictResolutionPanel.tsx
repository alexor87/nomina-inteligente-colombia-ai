...
export const ConflictResolutionPanel: React.FC<ConflictResolutionPanelProps> = ({
  ...
  const getSourceBadge = (source: 'vacation_module' | 'novedad_module') => (
    <Badge variant={source === 'vacation_module' ? 'default' : 'secondary'} className="text-xs">
      {source === 'vacation_module' ? 'Modulo Ausencias' : 'Modulo Novedades'}
    </Badge>
  );
    ...
    <div className="space-y-6">
      ...
      <Alert className="border-orange-200 bg-orange-50">
        ...
        <AlertDescription className="text-orange-800">
          ...
          entre el modulo de ausencias y novedades. Debes resolverlos antes de continuar con la liquidacion.
        </AlertDescription>
      </Alert>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-red-600">Registros identicos</p>
          </CardContent>
        </Card>
      ...
      {/* Controles de resolucion automatica */}
      <Card>
        <CardHeader>
          <CardTitle className="text-lg">Resolucion Automatica</CardTitle>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="flex items-center space-x-4">
            ...
            >
              ...
              <span>Priorizar Modulo Ausencias</span>
            </Button>
            <span className="text-sm text-muted-foreground">
              (Recomendado: usa los registros del modulo de ausencias como fuente principal)
            </span>
          </div>
        </CardContent>
      </Card>
      ...
      <CardContent className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="space-y-2">
            <h4 className="font-medium text-sm text-blue-700">Modulo Ausencias</h4>
          ...
          {/* Modulo Novedades */}
          <div className="space-y-2">
            <h4 className="font-medium text-sm text-gray-700">Modulo Novedades</h4>
        ...
        <div className="border-t pt-4">
          <h4 className="font-medium text-sm mb-3">Resolucion:</h4>
          ...
          {resolution && (
            <div className="mt-2 text-sm text-green-600 flex items-center space-x-1">
              <CheckCircle className="h-3 w-3" />
              <span>
                {resolution.action === 'prioritize_vacation' && 'Se usaran los registros del modulo de ausencias'}
                {resolution.action === 'prioritize_novedad' && 'Se usaran los registros del modulo de novedades'}
                {resolution.action === 'skip' && 'Se omitira este conflicto'}
              </span>
            </div>
          )}
        </div>
