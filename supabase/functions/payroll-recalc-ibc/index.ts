...
Deno.serve(async (req) => {
  ...
  try {
    ...
    console.log('🔄 IBC Recalculation Request:', requestBody)

    const { action, data } = requestBody

    if (action === 'recalculate_ibc') {
      console.log(`🚀 Starting IBC recalculation for period: ${data.period_id}`)
      ...
      console.log(`✅ IBC recalculation completed: ${processedCount} employees processed`)
