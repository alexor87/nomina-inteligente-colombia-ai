...
-- Primero, eliminar la política restrictiva actual que usa get_current_user_company_id()
...
-- Verificar que la política de SELECT sigue funcionando correctamente
-- Si es necesario, también la actualizamos para ser más flexible
