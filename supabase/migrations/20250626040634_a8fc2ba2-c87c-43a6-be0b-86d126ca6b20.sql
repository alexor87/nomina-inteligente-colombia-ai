...
-- Limpiar políticas RLS que puedan referenciar funciones de super-admin inexistentes
-- Recrear políticas limpias para user_roles
...
CREATE POLICY "Users can view own roles and company roles" 
